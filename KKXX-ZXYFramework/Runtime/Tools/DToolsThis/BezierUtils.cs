...
public class BezierUtils
{
    ...
    /// <summary>
    /// Linear Bessel curve, based on the T value, calculate the corresponding points on the Bessel curve
    /// </summary>
    /// <param name="t"></param>
    /// <param name="p0"></param>
    /// <param name="p1"></param>
    ...
    /// <summary>
    /// Quadratic Bessel curve, based on the value of T, calculate the corresponding points on the Bessel curve
    /// </summary>
    /// <param name="t"></param>
    /// <param name="p0"></param>
    /// <param name="p1"></param>
    ...
    /// <summary>
    /// Cubic Bezier curve, based on the T value, calculate the corresponding points on the Bezier curve
    /// </summary>
    /// <param name="t"></param>
    /// <param name="p0"></param>
    /// <param name="p1"></param>
    ...
    /// <summary>
    /// Gets the array that stores the points of the Bezier curve
    /// </summary>
    ...
    /// <summary>
    /// Gets an array of stored quadratic Bessel curve points
    /// </summary>
    /// <param name="startPoint"></param>
    /// <param name="controlPoint"></param>
    /// <param name="endPoint"></param>
    ...
    /// <summary>
    /// Gets an array of stored cubic Bezier curve points
    /// </summary>
    /// <param name="startPoint"></param>
