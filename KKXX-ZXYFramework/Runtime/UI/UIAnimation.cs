...
namespace Game
{
    ...
    public class UIAnimation : MonoBehaviour
    {
        ...
        public void InitialUIAnima()
        {
            ...
            allOpenAnima[UILayers.Pop7] = OpenPopAnima;
            allCloseAnima[UILayers.Pop7] = ClosePopAnima;
            allOpenAnima[UILayers.Pop8] = OpenPopAnima;
            allCloseAnima[UILayers.Pop8] = ClosePopAnima;
        }
        ...
        /// </summary>
        [HideInInspector]
        protected const float Speed = 0.07f;
        //弹窗层级的动画
        private void OpenPopAnima(System.Action openCallBack)
        {
            ...
            Transform ts = transform.GetChild(1);//这个动画对面板的构造有一定的要
